...
print(len(a))                       # 문자열의 길이 : 13
print(len([1, 2, 3]))               # 리스트의 길이(요소의 개수) : 3
...
# 주의사항: 특수문자, 공백문자, 대소문자까지 구분한다.

# 부분 문자열이 처음 등장하는 위치(인덱스)를 알려주는 문자열 메소드
print(s.find("Python"))             # 인덱스 반환
print(s.index("Python"))            # 인덱스 반환
print(s.find("Java"))               # 인덱스 반환 (없으면 -1 반환)
# print(s.index("Java"))            # 인덱스 반환 (없으면 오류 뜨면서 종료됨)
...
print("Java" not in s)              # 포함의 부정(True)
...
print("123".isnumeric())            # 숫자, 한자로 표기한 숫자, 로마자로 표기한 숫자이면 True
...
a = "apple,banana,kiwi"
fruits = a.split(",")               # ","를 기준으로 분리 (기본값 whitespace)
...
names = data.split()
print(names)                    # ✅ 리스트 출력
print(" ".join(names))          # ✅ "kim lee park choi"